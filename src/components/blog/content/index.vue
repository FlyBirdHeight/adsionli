    ...
    <div style="text-align:center">
        <el-container style="margin:auto;" :style="{width:maxWidth}">
            <el-header style="height:100px">
                <h1 style="text-align:left"><a href="javascript:;" @click="seeAll(1)" class="post-title-link">手动排查Linux磁盘占用</a></h1>
            ...
            <el-main style="text-align:left;height:420px;overflow:hidden;text-overflow: ellipsis;margin-top:20px">
            ...
            <el-footer style="text-align:right">
                <a class="btn_a" href="javascript:;" @click="seeAll()">
                    阅读全文 »
                </a>
            </el-footer>
        </el-container>
